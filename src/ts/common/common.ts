...
export const LEVEL_NAME_LIST: { [key in keyof typeof LEVEL_NAME]: string[] } = {
    [LEVEL_NAME.WORLD]: [
        'foreground',
        'foreground_2',
        'level/door',
        'level/decoration',
        'level/tree_foreground',
        'level/tree_background_2',
        'level/mountain',
        'level/fence',
        'level/grass',
    ],
    [LEVEL_NAME.DUNGEON_1]: ['dungeon_background', 'foreground'],
};
