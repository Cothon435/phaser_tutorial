...
export const ASSET_KEYS = {
  ...
  DUNGEON_1_TILESET_IMG: 'Legend_Spider_Dungeon',
  DUNGEON_1_TILESET_IMGKEY: 'DUNGEON_1_TILESET',
  ...
  WORLD_TILESET_IMG: 'grassland_resized',
  WORLD_TILESET_IMGKEY: 'WORLD_TILESET',
